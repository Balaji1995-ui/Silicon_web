<?php require 'header.php'; ?>
      ...
      <section class="dark-mode position-relative jarallax pb-xl-3" data-jarallax data-speed="0.4">
        ...
        <!-- Parallax img -->
        <div class="jarallax-img bg-dark opacity-70" style="background-image: url(assets/img/blog/single/cover-image.jpg);"></div>
        ...
        <div class="container position-relative pb-5 zindex-5">
          ...
          <div class="row mb-xxl-5 py-md-4 py-lg-5">
            <div class="col-lg-6 col-md-7 pb-3 pb-md-0 mb-4 mb-md-5">
              ...
              <h1 class="display-5 pb-md-3">This Long-Awaited Technology May Finally Change the World</h1>
              ...
              <a href="blog-single.php" class="btn btn-lg btn-primary">
                Read article
                      ...
                      <div class="col">
                        <article class="card h-100 border-0 shadow-sm card-hover-primary">
                          <div class="card-body pb-0">
                            ...
                            <h3 class="h5 mb-0">
                              <a href="blog-single.php" class="stretched-link">Mobile App Generates Data for the Energy Management</a>
                            </h3>
                          </div>
                      ...
                      <div class="col">
                        <article class="card h-100 border-0 shadow-sm card-hover-primary">
                          <div class="card-body pb-0">
                            ...
                            <h3 class="h5 mb-0">
                              <a href="blog-single.php" class="stretched-link">How the Millennial Lifestyle Changes as Service Prices Rise</a>
                            </h3>
                          </div>
                          <div class="card-footer d-flex align-items-center py-4 text-muted border-top-0">
                            <div class="d-flex align-items-center me-3">
                      ...
                      <div class="col">
                        <article class="card h-100 border-0 shadow-sm card-hover-primary">
                          <div class="card-body pb-0">
                            ...
                            <h3 class="h5 mb-0">
                              <a href="blog-single.php" class="stretched-link">Inclusive Marketing: Why and How Does it Work?</a>
                            </h3>
                          </div>
                          <div class="card-footer d-flex align-items-center py-4 text-muted border-top-0">
                            <div class="d-flex align-items-center me-3">
                      ...
                      <div class="col">
                        <article class="card h-100 border-0 shadow-sm card-hover-primary">
                          <div class="card-body pb-0">
                            ...
                            <h3 class="h5 mb-0">
                              <a href="blog-single.php" class="stretched-link">A Study on Smartwatch Design Qualities and People’s Preferences</a>
                            </h3>
                          </div>
                          <div class="card-footer d-flex align-items-center py-4 text-muted border-top-0">
                            <div class="d-flex align-items-center me-3">
                      ...
                      <div class="col">
                        <article class="card h-100 border-0 shadow-sm card-hover-primary">
                          <div class="card-body pb-0">
                            ...
                            <h3 class="h5 mb-0">
                              <a href="blog-single.php" class="stretched-link">Why UX Design Matters and How it Affects Ranking</a>
                            </h3>
                          </div>
                          <div class="card-footer d-flex align-items-center py-4 text-muted border-top-0">
                            <div class="d-flex align-items-center me-3">
                      ...
                      <div class="col">
                        <article class="card h-100 border-0 shadow-sm card-hover-primary">
                          <div class="card-body pb-0">
                            ...
                            <h3 class="h5 mb-0">
                              <a href="blog-single.php" class="stretched-link">This Week in Search: New Limits and Exciting Features</a>
                            </h3>
                          </div>
                          <div class="card-footer d-flex align-items-center py-4 text-muted border-top-0">
                            <div class="d-flex align-items-center me-3">
              ...
              <div class="swiper-slide h-auto px-2">
                <article class="card border-0 h-100 mx-1">
                  ...
                  <div class="card-body pb-4">
                    ...
                    <h3 class="h5 mb-0">
                      <a href="blog-single.php">Why UX Design Matters and How it Affects Ranking</a>
                    </h3>
                  </div>
                  <div class="card-footer py-4">
                    <a href="#" class="d-flex align-items-center fw-bold text-dark text-decoration-none">
              ...
              <div class="swiper-slide h-auto px-2">
                <article class="card border-0 h-100 mx-1">
                  ...
                  <div class="card-body pb-4">
                    ...
                    <h3 class="h5 mb-0">
                      <a href="blog-single.php">Five Effective Lead Generation Techniques For Your Business</a>
                    </h3>
                  </div>
                  <div class="card-footer py-4">
                    <a href="#" class="d-flex align-items-center fw-bold text-dark text-decoration-none">
              ...
              <div class="swiper-slide h-auto px-2">
                <article class="card border-0 h-100 mx-1">
                  ...
                  <div class="card-body pb-4">
                    ...
                    <h3 class="h5 mb-0">
                      <a href="blog-single.php">Inclusive Marketing: Why and How Does it Work?</a>
                    </h3>
                  </div>
                  <div class="card-footer py-4">
                    <a href="#" class="d-flex align-items-center fw-bold text-dark text-decoration-none">
              ...
              <div class="swiper-slide h-auto px-2">
                <article class="card border-0 h-100 mx-1">
                  ...
                  <div class="card-body pb-4">
                    ...
                    <h3 class="h5 mb-0">
                      <a href="blog-single.php">Your Guide to Optimising A JavaScript-enabled Website</a>
                    </h3>
                  </div>
                  <div class="card-footer py-4">
                    <a href="#" class="d-flex align-items-center fw-bold text-dark text-decoration-none">
      ...
      <section class="container mb-5 pt-5 pb-lg-5">
        ...
        <ul class="nav nav-tabs justify-content-center mb-lg-5 mb-4 pb-lg-2">
          <li class="nav-item">
            <a href="#" class="nav-link active">All Topics</a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a href="#" class="nav-link">Startups</a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a href="#" class="nav-link">Processes &amp; Tools</a>
          </li>
        </ul>
        ...
        <div class="pb-3">
          ...
          <article class="card border-0 shadow-sm overflow-hidden mb-4">
            <div class="row g-0">
              <div class="col-sm-4 position-relative bg-repeat-0 bg-size-cover" style="background-image: url(assets/img/blog/06.jpg); min-height: 15rem;">
                <a href="blog-single.php" class="position-absolute top-0 start-0 w-100 h-100" aria-label="Read more"></a>
                <a href="#" class="btn btn-icon btn-light bg-white border-white btn-sm rounded-circle position-absolute top-0 end-0 zindex-5 me-3 mt-3" data-bs-toggle="tooltip" data-bs-placement="left" title="Read later">
                  <i class="bx bx-bookmark"></i>
                </a>
          ...
          <article class="card border-0 shadow-sm overflow-hidden mb-4">
            <div class="row g-0">
              <div class="col-sm-4 position-relative bg-repeat-0 bg-size-cover" style="background-image: url(assets/img/blog/05.jpg); min-height: 15rem;">
                <a href="blog-single.php" class="position-absolute top-0 start-0 w-100 h-100" aria-label="Read more"></a>
                <a href="#" class="btn btn-icon btn-light bg-white border-white btn-sm rounded-circle position-absolute top-0 end-0 zindex-5 me-3 mt-3" data-bs-toggle="tooltip" data-bs-placement="left" title="Read later">
                  <i class="bx bx-bookmark"></i>
                </a>
          ...
          <article class="card border-0 shadow-sm overflow-hidden mb-4">
            <div class="row g-0">
              <div class="col-sm-4 position-relative bg-repeat-0 bg-size-cover" style="background-image: url(assets/img/blog/09.jpg); min-height: 15rem;">
                <a href="blog-single.php" class="position-absolute top-0 start-0 w-100 h-100" aria-label="Read more"></a>
                <a href="#" class="btn btn-icon btn-light bg-white border-white btn-sm rounded-circle position-absolute top-0 end-0 zindex-5 me-3 mt-3" data-bs-toggle="tooltip" data-bs-placement="left" title="Read later">
                  <i class="bx bx-bookmark"></i>
                </a>
              ...
              <div class="col-sm-8">
                <div class="card-body">
                  ...
                  <h3 class="h4">
                    <a href="blog-single.php">This Long-Awaited Technology May Finally Change the World</a>
                  </h3>
        ...
        <div class="row">
          <div class="col-xl-3">
            <div class="d-xl-block d-flex align-items-center justify-content-between mb-xl-0 mb-4 pb-xl-0 pb-3">
              <h2 class="h1 mb-xl-4 mb-0 pb-xl-3">Latest Podcasts</h2>
              <a href="#" class="btn btn-primary ms-xl-0 ms-4">All podcasts</a>
            </div>
          </div>
              ...
              <div class="swiper-wrapper">
                ...
                <article class="swiper-slide h-auto pb-3">
                  <div class="d-block position-relative rounded-3 mb-3">
                    ...
                    <a href="blog-podcast.php" class="position-absolute top-0 start-0 w-100 h-100 bg-primary opacity-35 rounded-3" aria-label="Listen podcast"></a>
                  ...
                  <h3 class="h5">
                    <a href="blog-podcast.php">IOS and the Changing landscape of Data Privacy</a>
                  </h3>
                  <div class="d-flex align-items-center text-muted">
                    <div class="d-flex align-items-center me-3">
                      <i class="bx bx-like fs-lg me-1"></i>
                  ...
                  <a href="blog-podcast.php" class="btn btn-link px-0 mt-3">
                ...
                <article class="swiper-slide h-auto pb-3">
                  ...
                  <h3 class="h5">
                    <a href="blog-podcast.php">Behavioral Science and Digital Marketing</a>
                  </h3>
                  <div class="d-flex align-items-center text-muted">
                    <div class="d-flex align-items-center me-3">
                      <i class="bx bx-like fs-lg me-1"></i>
                ...
                <article class="swiper-slide h-auto pb-3">
                  ...
                  <h3 class="h5">
                    <a href="blog-podcast.php">Why You Should Care About Your Competitors</a>
                  </h3>
                  <div class="d-flex align-items-center text-muted">
                    <div class="d-flex align-items-center me-3">
                      <i class="bx bx-like fs-lg me-1"></i>
                ...
                <article class="swiper-slide h-auto pb-3">
                  ...
                  <h3 class="h5">
                    <a href="blog-podcast.php">Tips for Marketing Managers: How to Maximise Leads</a>
                  </h3>
                  <div class="d-flex align-items-center text-muted">
                    <div class="d-flex align-items-center me-3">
                      <i class="bx bx-like fs-lg me-1"></i>
