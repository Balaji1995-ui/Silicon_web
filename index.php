<?php require 'header.php';  require 'admin/api/lib.php'; ?>
      ...
      <section class="jarallax dark-mode bg-dark py-xxl-5" data-jarallax data-speed="0.4">
          ...
          <div class="container text-center py-xl-5">
            ...
            <!-- Item -->
                    <div class="swiper-slide"  >
                      ...
                      <h2 class="display-2 from-start mb-lg-4" <?php echo $Car['id'] ?>><?php echo $Car['title'] ?></h2>
                      <div class="from-end">
                        <p class="fs-xl text-light opacity-70 pb-2 mb-lg-5"><?php echo $Car['sub_title']?></p>
                      </div>
                    ...
                    <!-- Item -->
                    <div class="swiper-slide" >
                      <h2 class="display-2 from-start mb-lg-4" ><?php echo $Car['title1'] ?></h2>
                      <div class="from-end">
                        <p class="fs-xl text-light opacity-70 pb-2 mb-lg-5">We build complex web, desktop and mobil

                        e applications. With us you get quality software and perfect service every time.</p>
                      </div>
                      <div class="scale-up delay-1">
                        <a href="case_study.php" class="btn btn-primary shadow-primary btn-lg">View case studies</a>
                      </div>
                    </div>
        
                    <!-- Item -->
                    <div class="swiper-slide">
                      <h2 class="display-2 from-start mb-lg-4"><?php echo $Car['title2'] ?></h2>
                      <div class="from-end">
                      ...
                      <div class="scale-up delay-1">
                        <a href="contact.php" class="btn btn-primary shadow-primary btn-lg">Work with us</a>
                      </div>
                    </div>
                  </div>
        ...
        <div class="container d-flex flex-column flex-sm-row align-items-center justify-content-between position-relative zindex-5 pb-5">
          ...
          <a href="case_study.php" class="nav-link px-0">
            Our case studies
      ...
      <section class="container pt-5 mt-2 mt-md-4 mt-lg-5">
        <div class="row pt-xl-3">
          <div class="col-md-5 text-center text-md-start pb-5">
            ...
            <a href="about-v2.php" class="btn btn-primary shadow-primary btn-lg">More about us</a>
        ...
        <div class="container pb-4 pt-5">
          ...
          <div class="row align-items-center pb-5 mb-lg-2">
            ...
            <div class="col-md-4 d-flex justify-content-center justify-content-md-end">
              <a href="services.php" class="btn btn-outline-primary btn-lg">See all services</a>
            </div>
          </div>
          <div class="row row-cols-1 row-cols-md-2">
            ...
            <div class="col py-4 my-2 my-sm-3">
              <a href="services-single.php" class="card card-hover h-100 border-0 shadow-sm text-decoration-none pt-5 px-sm-3 px-md-0 px-lg-3 pb-sm-3 pb-md-0 pb-lg-3 me-xl-2">
                <div class="card-body pt-3">
                  ...
                  <p class="fs-sm text-body mb-0" ><?php echo $Car['Card1'] ?></p>
                </div>
              </a>
            </div>
            ...
            <!-- Item -->
            <div class="col py-4 my-2 my-sm-3">
              <a href="services-single.php" class="card card-hover h-100 border-0 shadow-sm text-decoration-none pt-5 px-sm-3 px-md-0 px-lg-3 pb-sm-3 pb-md-0 pb-lg-3 ms-xl-2">
                <div class="card-body pt-3">
                  <div class="d-inline-block bg-primary shadow-primary rounded-3 position-absolute top-0 translate-middle-y p-3">
                  ...
                  <p class="fs-sm text-body mb-0" <?php echo $Car['id'] ?>><?php echo $Car['Card2'] ?></p>
                </div>
              </a>
            </div>
            ...
            <div class="col py-4 my-2 my-sm-3">
              <a href="services-single.php" class="card card-hover h-100 border-0 shadow-sm text-decoration-none pt-5 px-sm-3 px-md-0 px-lg-3 pb-sm-3 pb-md-0 pb-lg-3 ms-xl-2">
                <div class="card-body pt-3">
                  ...
                  <p class="fs-sm text-body mb-0"><?php echo $Car['Card3'] ?></p>
                </div>
              </a>
            </div>
            ...
            <div class="col py-4 my-2 my-sm-3">
              <a href="services-single.php" class="card card-hover h-100 border-0 shadow-sm text-decoration-none pt-5 px-sm-3 px-md-0 px-lg-3 pb-sm-3 pb-md-0 pb-lg-3 ms-xl-2">
                <div class="card-body pt-3">
                  ...
                  <p class="fs-sm text-body mb-0"><?php echo $Car['Card4'] ?></p>
                </div>
              </a>
            </div>
            ...
            <div class="col py-4 my-2 my-sm-3">
              <a href="services-single.php" class="card card-hover h-100 border-0 shadow-sm text-decoration-none pt-5 px-sm-3 px-md-0 px-lg-3 pb-sm-3 pb-md-0 pb-lg-3 ms-xl-2">
                <div class="card-body pt-3">
                  ...
                  <p class="fs-sm text-body mb-0"><?php echo $Car['Card5'] ?></p>
                </div>
              </a>
            </div>
            ...
            <div class="col py-4 my-2 my-sm-3">
              <a href="services-single.php" class="card card-hover h-100 border-0 shadow-sm text-decoration-none pt-5 px-sm-3 px-md-0 px-lg-3 pb-sm-3 pb-md-0 pb-lg-3 ms-xl-2">
                <div class="card-body pt-3">
                  ...
                  <p class="fs-sm text-body mb-0"><?php echo $Car['Card6'] ?></p>
                </div>
              </a>
            </div>
          </div>
        ...
        <div class="container">
          ...
          <div class="row align-items-center pb-5">
            ...
            <div class="col-md-4 col-lg-5 col-xl-6 d-flex justify-content-center justify-content-md-end">
              <a href="case_study.php" class="btn btn-outline-primary btn-lg">See all case studies</a>
            </div>
          </div>
        </div>
                    ...
                    <div class="swiper" data-swiper-options='{
                      ...
                      <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide" data-swiper-tab="#image-1">
                          ...
                          <a href="case_study.php" class="btn btn-primary">View case study</a>
                        </div>
                ...
                <div class="swiper-slide h-auto py-3">
                  <article class="card p-md-3 p-2 border-0 shadow-sm card-hover-primary h-100 mx-2">
                    <div class="card-body pb-0">
                      ...
                      <h3 class="h4">
                        <a href="blog-single.php" class="stretched-link">What the Software Stock Slump Means for the Market</a>
                      </h3>
                ...
                <div class="swiper-slide h-auto py-3">
                  <article class="card p-md-3 p-2 border-0 shadow-sm card-hover-primary h-100 mx-2">
                    <div class="card-body pb-0">
                      ...
                      <h3 class="h4">
                        <a href="blog-single.php" class="stretched-link">5 Bad Landing Page Examples & How We Would Fix Them</a>
                      </h3>
