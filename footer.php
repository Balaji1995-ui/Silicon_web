          ...
          <div class="col-xl-6 col-lg-7 col-md-5 offset-xl-2 offset-md-1 pt-4 pt-md-1 pt-lg-0">
            <div id="footer-links" class="row">
              ...
              <div class="col-xl-4 col-lg-3">
                ...
                <?php
              $result = fetchSingleSocial();
              while ($Car = mysqli_fetch_assoc($result)) {
                
            ?>
                  <ul class="nav flex-column mb-2 mb-lg-0">
                    <li class="nav-item"><a href="<?php echo $Car['Facebook_Link']?>" class="nav-link d-inline-block px-0 pt-1 pb-2">Facebook</a></li>
                    <li class="nav-item"><a href="<?php echo $Car['LinkedIn_Link']?>" class="nav-link d-inline-block px-0 pt-1 pb-2">LinkedIn</a></li>
                    <li class="nav-item"><a href="<?php echo $Car['Twitter_Link']?>" class="nav-link d-inline-block px-0 pt-1 pb-2">Twitter</a></li>
                    <li class="nav-item"><a href="<?php echo $Car['Instagram_Link']?>" class="nav-link d-inline-block px-0 pt-1 pb-2">Instagram</a></li>
                  </ul>
